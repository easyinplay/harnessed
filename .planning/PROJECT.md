...
Shipped to npm + dogfooded across maintainer machines. v1.0 GA + v2.0 + v3.0 all shipped (current published **v4.1.3**, 2026-06-04). 1100+ tests passing (1107 at v4.1.3), CI green on 3 platforms.

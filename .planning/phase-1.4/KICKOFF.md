...
- [ ] **C3** 6 category routing rules MVP execute — design / content / testing / search 4 category 实测命中（engineering category v1 占位 0 rules base 已装；meta category 推 phase 1.5）；每 category ≥ 5 真实样本验证

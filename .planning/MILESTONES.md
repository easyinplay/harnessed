...
| v15.0 Upstream Re-sync | 2026-07-13 (npm 4.29.0) | 7-pin 侦察 → 双主菜(pwf v3.4.1 Windows session-catchup 修复 + mattpocock to-spec/to-tickets 改名对齐)+ 三顺手(superpowers 6.1.1 / gstack 1.60.1.0 / gsd-core lkg 1.6.1);gsd-core 1.7.0 GA watch 项。closed lightweight。 | `phases/45-upstream-resync-v15/` |

...
> (latest published: 4.2.0); milestone names (v2.0, v3.0, v5.0) are spec/era codenames.
...
|-----------|--------|-------|
| v5.0 State Machine Core (Spec 1) | Spec 1 shipped (npm 4.2.0, 2026-06-05) | structured progress ledger + fail-closed evidence guard + `status --recover`. Working dir `.planning/v5.0/`. Spec 2/3 deferred. |

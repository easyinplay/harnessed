...
> **启动日期**: 2026-05-12
> **预计工作量**: plan-phase 1.5-2 hour + execute-phase 5-7 工作日（v3 ROADMAP § Phase 1.3 行 — H3 sister patch transparency 修订；初估 3-5 天偏乐观，历史 phase 1.1/1.2 实际比估时长）
...
- [ ] **B4** `routing/decision_rules.yaml` v1 schema 落地 — 从 GRAY-AREA-1 § 2 提取 6 category × ≥ 12 rules MVP（含 design / content / testing / search / meta / engineering decision_rule_anchor）
...
routing/decision_rules.yaml                     # B4 ship (W execute)

...
- **Current focus**: **No active milestone. Latest npm 4.11.0** (design capability swap: anthropic `frontend-design` Claude-only → cross-agent `design-taste-frontend` from Leonxlnx/taste-skill, re-defined as a two-stage overlay — ui-ux-pro-max structure → design-taste-frontend polish). Prior: 4.10.1 installer robustness; v12.0 Forward Continuation 4.10.0; v11.0 4.9.0; issue #1 4.9.1.

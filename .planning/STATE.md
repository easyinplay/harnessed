...
- **GSD phase**：🎯 **Phase v3.0-3.6 close + ship SHIPPED — v3.0.0 GA COMPLETE** (2026-05-21)；🔧 **v3.9.x 维护系列 active** — v3.9.17 最新 (2026-05-27)；共 11 个维护版本 (v3.9.7 → v3.9.17)，详见 `.planning/v3.9.x/MAINTENANCE-LOG.md`

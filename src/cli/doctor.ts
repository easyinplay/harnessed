...
export function registerDoctor(program: Command): void {
  program
    .command('doctor')
    .description(
      'Preflight checks (Node / MCP scope / jq / Win bash / origin URL / gstack prefix / deprecations / token budget / Agent Teams / planning-with-files / mattpocock-skills / MCP availability / ECC / plugin freshness)',
    )

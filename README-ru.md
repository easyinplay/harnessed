...
- **Composition Skill** — собственные workflow-скиллы играют роль дирижёрской палочки, оркестрируя несколько апстримов в унисон. **1 супер-мастер `/auto` + 5 мастеров стадий + 19 суб-воркфлоу + 2 standalone = 27 workflow с неймспейс-иерархией**, полное 5-стадийное машинное исполнение (`/auto` одним выстрелом по всем стадиям / `/discuss /plan /task /verify /ship` по одной стадии / 19 суб-воркфлоу three-layer-stack / `/research /retro` 2 standalone)
...
# ... выберите любой из остальных 19 суб-воркфлоу
```
...
│   /discuss /plan /task /verify /ship (мастер) + 19 суб + /research /retro + /auto супер-мастер

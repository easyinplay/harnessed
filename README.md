...
> **Status:** 🎯 **v0.2.0 MILESTONE 4/4 SHIPPED & ARCHIVED 2026-05-16** (Phase 2.1+2.2+2.3+2.4) · 🎯 **v0.3.0 MILESTONE 4/4 SHIPPED & ARCHIVED 2026-05-17** (Phase 3.1+3.2+3.3+3.4) · **Phase 3.4 SHIPPED 2026-05-17** — 路由命中率 ≥ 85% 验收 30/30 = 100% 远超 ≥85% bar 15% headroom per-tier Sonnet/Haiku/Opus 100/100/100 (D-01 REAL HISTORICAL + D-02 RUN ENGINE per-sample arbitrate dispatch) + check-token-budget.ts 48L PRIMARY helper 4th family member sister Phase 3.1+3.2+3.3 precedent + doctor.ts 8th check token budget DOCTOR-ONLY-WARN status='warn'≠fail (D-03 Buffer.byteLength /4 zero-dep estimateTokens + D-04 sister Phase 3.3 D-02 install path 安静 一致 + 195→199L ≤200L Karpathy clean B-03 NOT invoked) + W0.1 STRATEGIC institutionalize 4 D-decisions D1-D4 6th STATE 类反模式 root-cause framing + W0 backlog 5 项一次根治 + ADR 0017 9 章节 errata (v0.3.0 milestone 4/4 CLOSE). Next: v0.4.0 dogfooding benchmark + co-maintainer 招募 + ADR 全集 + 路由审计日志.

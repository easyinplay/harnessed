...
- [x] **B4 eval harness** — Slice A SHIPPED 4.31.0(trap suite + coverage 导航;B1 证据包 SHIPPED(docs/evidence/2026-07-b1/,16 干净 run 双 arm 全满分,三结论含边界声明与 issue #7 完工不退出缺陷);C 录制器待续;后续差异化实验需另一形态(模糊 spec/跨 session))

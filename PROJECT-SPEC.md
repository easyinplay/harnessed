...
> **状态（v7.0 规划中）**
>
> - **当前 milestone**：v7.0 Gap-Close & Memory Loop（planning）· npm latest: 4.4.0
> - **Spec 状态**：Locked v3 · v2 决策完成日期：2026-05-11 · v3 wedge 升级：2026-05-12
>
> **Shipped milestones（结论摘要，详情见归档）**
>
> - v0.1.0 (2026-05-12~15) — manifest 引擎 + research workflow · .planning/milestones/v0.1.0-MILESTONE-AUDIT.md
> - v0.2.0 (2026-05-16) — sub-task loop + extension installers · .planning/milestones/v0.2.0-MILESTONE-AUDIT.md
> - v0.3.0 (2026-05-17) — plan-feature + checkpoint engine; routing 30/30 100% · .planning/milestones/v0.3.0-MILESTONE-AUDIT.md
> - v0.4.0 (2026-05-19) — dogfooding + 稳定期 · .planning/milestones/v0.4.0-MILESTONE-AUDIT.md
> - v0.5.0 / v1.0 GA (2026-05-22) — v1.0-RC2 hardening → production GA · .planning/milestones/v0.5.0-MILESTONE-AUDIT.md
> - v6.0 Doc-Discipline Substrate (2026-06-11) — Phase 11+12 shipped, 1188 tests · .planning/milestones/
>
> **完整历史叙事**：CHANGELOG.md · .planning/RETROSPECTIVE.md · .planning/milestones/*-MILESTONE-AUDIT.md
>
> **下一步**：见 .planning/ROADMAP.md active section (v7.0 Gap-Close & Memory Loop，Phase 13–19)
